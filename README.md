...
Below is the current coverage of CIS v6.0.0 controls implemented in this repository.
...
| 1.3.8 – Sway external sharing restricted | `CIS_1_3_8.ps1` | Manual — No API exists (script provides guidance) |
